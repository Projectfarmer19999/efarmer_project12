...
if (isset($_POST['btnsubmit'])) {
    ...
    if (empty($error)) {
        echo $sql_query = "INSERT INTO users(name,email,phone_no,user_type,password,adding_date)"
        . "VALUES('" . $name . "','" . $email . "','" . $phone_no . "','".$user_type."','" . $password . "','" . date('Y-m-d h:i:s') . "')";
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <figure class="frame thumbnail alignnone clearfix">
                        <p><img class="size-full " alt="usa" src="images/amity.jpeg" width="" height="250"></p>
                    </figure>                   						
                </div>
            </div>
        </div>       
