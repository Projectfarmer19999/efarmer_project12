...
if (!empty($user_id)) {
    ...
    if (isset($_GET['id']) && !empty($_GET['id'])) {
        ...
        if ($valueInsert > 0) {
            header("location:expert_list.php?status=success");
        } else {
            $error = "Expert has not been deleted.";
        }
    }
    ?>
    <html>
        <head>
            <title>Expert List - E-Farmer </title>
                    ...
                    <div class="col-md-8">
                        ...
                        <table class="table_list">
                            ...
                            if (isset($_GET['status']) && $_GET['status'] == "success") {
                                echo '<tr><td colspan="4">Expert has been successfully deleted.</td></tr>';
                            }
                            if (!empty($error)) {
